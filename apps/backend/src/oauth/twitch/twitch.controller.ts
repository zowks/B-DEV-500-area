...
@ApiTags("Twitch OAuth")
@Controller("oauth/twitch")
export class TwitchOAuthController implements OAuthController {
    constructor(private readonly oauthManager: TwitchOAuthService) {}
